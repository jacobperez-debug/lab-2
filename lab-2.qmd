...
```{r}
#| label: improving the bad visualization

ggplot(summary_df, aes(x = prop, y = country_name, color = region)) +
  geom_point() +
  ...
  geom_text(data = region_medians,
          aes(x = median_prop, y = 1,
              label = paste0(round(median_prop * 100, 1), "%")),
          color = "black",
          size = 3) +
